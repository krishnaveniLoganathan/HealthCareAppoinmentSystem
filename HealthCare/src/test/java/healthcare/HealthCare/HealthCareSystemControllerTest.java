...
public class HealthCareSystemControllerTest extends HealthCareApplicationTests{
	...
	public void testEmployee() throws Exception {
		mockMvc.perform(get("/allappoinments")).andExpect(status().isOk());
		/*
